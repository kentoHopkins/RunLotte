  ...
  return (
    <StyledWrapper>
      <div className="social">
        ...
        <a href="https://x.com/HenryGreen51444" target="_blank" className="socialContainer containerX">
        ...
        <a href="https://linktr.ee/runlit" target="_blank" className="socialContainer containerThree">
